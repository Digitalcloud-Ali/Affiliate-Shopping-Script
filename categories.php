...
mysql_select_db($database_shops, $shops);
$query_sitemaps = "SELECT * FROM subcates";
...
<title><?php echo $domainname ?> - Categories</title>
<meta name="description" content="<?php echo $domainname ?> - Explore All Categories At Once To Find The Products Quickly Of Need. We Offer The Thousand Of Cheap Discount Products / Discount Shops &amp; Stores." />
<meta name="keywords" content="<?php echo $domainnamespace ?> , Explore All Categories , Find Products, Quickly , Discount Products , Discount Shops , Discount Stores" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="650" valign="top"><table width="203%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="10" class="style9"><input name="pageid" type="hidden" id="pageid" value="<?php echo $row_pages['pageid']; ?>" /></td>
        <td class="style9"><span class="pagestitle">Categories </span> :
          <table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="7"></td>
              </tr>
