...
// Start Variable definitions
  ...
  $tNG_login_config["connection"] = "shops";
  $tNG_login_config["table"] = "spadmins";
  $tNG_login_config["pk_field"] = "admid";
  $tNG_login_config["pk_type"] = "NUMERIC_TYPE";
  $tNG_login_config["email_field"] = "";
  $tNG_login_config["user_field"] = "aduser";
  $tNG_login_config["password_field"] = "adpass";
  ...
  $tNG_login_config["redirect_failed"] = "AKk9Ki39lk2997/error.php";
  $tNG_login_config["redirect_success"] = "AKk9Ki39lk2997/main.php";
  $tNG_login_config["login_page"] = "AKk9Ki39lk2997/login.php";
  ...
  $tNG_login_config_session["kt_login_id"] = "admid";
  $tNG_login_config_session["kt_login_user"] = "aduser";
